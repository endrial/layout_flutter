...
let modulePaths = {
 ...
 "packages/test_layout/NavBar/NavBar": "packages/test_layout/NavBar/NavBar.ddc",
 "packages/test_layout/layout": "packages/test_layout/layout.ddc",
 "packages/test_layout/main": "packages/test_layout/main.ddc",
 "packages/test_layout/main_web_entrypoint": "packages/test_layout/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/test_layout/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:test_layout/main_web_entrypoint.dart") {
          // Clear static caches.
