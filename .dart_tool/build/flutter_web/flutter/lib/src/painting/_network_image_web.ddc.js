define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  const _SizeAwareCacheKey_providerCacheKey = dart.privateName(image_provider, "_SizeAwareCacheKey.providerCacheKey");
  const _SizeAwareCacheKey_width = dart.privateName(image_provider, "_SizeAwareCacheKey.width");
  const _SizeAwareCacheKey_height = dart.privateName(image_provider, "_SizeAwareCacheKey.height");
  ...
  const providerCacheKey$ = _SizeAwareCacheKey_providerCacheKey;
  const width$0 = _SizeAwareCacheKey_width;
  const height$ = _SizeAwareCacheKey_height;
  ...
  const ResizeImage_imageProvider = dart.privateName(image_provider, "ResizeImage.imageProvider");
  const ResizeImage_width = dart.privateName(image_provider, "ResizeImage.width");
  const ResizeImage_height = dart.privateName(image_provider, "ResizeImage.height");
  ...
  const imageProvider$ = ResizeImage_imageProvider;
  const width$1 = ResizeImage_width;
  const height$0 = ResizeImage_height;
  ...
  const GradientRotation_radians = dart.privateName(gradient, "GradientRotation.radians");
  ...
  const radians$ = GradientRotation_radians;
  ...
  const transform$ = Gradient_transform;
  ...
  const height$1 = TextStyle_height;
  ...
  const height$2 = StrutStyle_height;
